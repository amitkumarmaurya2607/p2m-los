...
function InnkedIcon({ color = "#000", size = 28 }: { color?: string; size?: number }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path
        d="M6.9987 10.5H2.33203V24.5H6.9987V10.5Z"
        stroke={color}
        strokeWidth="2.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M4.66536 7.00065C5.95403 7.00065 6.9987 5.95598 6.9987 4.66732C6.9987 3.37865 5.95403 2.33398 4.66536 2.33398C3.3767 2.33398 2.33203 3.37865 2.33203 4.66732C2.33203 5.95598 3.3767 7.00065 4.66536 7.00065Z"
        stroke={color}
        strokeWidth="2.33333"
        strokeLinecap="round"
        strokeLinejoin="round"
