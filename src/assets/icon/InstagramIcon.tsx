...
function InstagramIcon({ color = "#000", size = 28 }: { color?: string; size?: number }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path
        d="M19.832 2.33398H8.16536C4.9437 2.33398 2.33203 4.94566 2.33203 8.16732V19.834C2.33203 23.0556 4.9437 25.6673 8.16536 25.6673H19.832C23.0537 25.6673 25.6654 23.0556 25.6654 19.834V8.16732C25.6654 4.94566 23.0537 2.33398 19.832 2.33398Z"
        stroke={color}
        strokeWidth="2.33333"
        strokeLinecap="round"
