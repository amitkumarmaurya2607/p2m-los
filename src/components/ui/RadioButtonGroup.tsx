...
const RadioButtonGroup = ({
  ...
  return (
    <div className={cn("flex flex-col gap-[6px]", className)}>
      ...
      <div className="flex flex-wrap rounded-[0.5rem] bg-muted p-1 shadow-[0_0_0px_1px_rgba(0,0,0,0.06)] text-sm">
        {options.map((option) => (
          <label
            key={option.value}
          ...
          >
            ...
            <span
              className={cn(
                ...
                "before:content-[''] before:absolute before:w-1 before:h-1 before:rounded-full before:bg-primary",
                "before:opacity-0 before:top-[-8px] before:left-1/2 before:-translate-x-1/2",
                "after:content-[''] after:absolute after:w-1 after:h-1 after:rounded-full after:bg-primary",
