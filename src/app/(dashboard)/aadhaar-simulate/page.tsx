    ...
    const handleSimulateAadhaar = () => {
        ...
        setTimeout(() => {
            window.location.href =
                "/aadhar-details/processing?txnId=SIMULATED_AADHAAR_123456";
        }, 1500);
    };
                ...
                <div className="rounded-3xl border bg-card p-5 sm:p-6 shadow-sm">
                        ...
                        <div className="relative h-[350px] flex items-center justify-center bg-gradient-to-br from-[#0F172A] via-[#111827] to-black">
                            ...
                            <div className="relative z-10 w-full px-6 text-center text-white">
                                ...
                                <p className="text-sm leading-6 text-white/70 max-w-[330px] mx-auto">
                                    Use this test screen to simulate a successful Aadhaar DigiLocker
                    ...
                    <div className="mt-5 rounded-3xl border bg-background p-5">
                        ...
                        <GradientButton
                            ...
                            type="button"
                            disabled={loading}
                            className="w-full mt-4 sm:mt-6 bg-gradient-to-r from-home-purple to-home-purple-dark disabled:opacity-70 disabled:cursor-not-allowed"
                        >
