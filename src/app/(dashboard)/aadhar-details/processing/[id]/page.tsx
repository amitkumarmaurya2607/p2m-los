                    ...
                    >
                        ...
                        <div className="relative z-10 w-full px-6 text-center text-white">
                            ...
                            <p className="text-sm leading-6 text-white/70 max-w-[300px] mx-auto">
                                ...
                                {status === "error" &&
                                    (errorMsg || "Verification could not be completed.")}
                            </p>
                ...
                <div className="mt-5 rounded-3xl border bg-card p-5 shadow-sm">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-3">
                            <div
                                className={`mt-0.5 flex h-7 w-7 items-center justify-center rounded-full ${status !== "error"
                                    ? "bg-green-100"
                                    : "bg-muted"
                                    }`}
                            >
                        ...
                        <div className="flex items-start gap-3">
                            <div
                                className={`mt-0.5 flex h-7 w-7 items-center justify-center rounded-full ${status === "success"
                                    ? "bg-green-100"
                                    : status === "error"
                                        ? "bg-destructive/10"
                                        : "bg-primary/10"
