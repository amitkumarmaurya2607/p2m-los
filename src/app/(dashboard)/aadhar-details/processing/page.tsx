...
export default function AadhaarProcessingPage({ params }: { params: { id: string } }) {
  console.log("Processing Aadhaar ID:", params.id);
  return (
          ...
          >
            ...
            <div className="relative z-10 w-full px-6 text-center text-white">
              <div className="relative mx-auto mb-6 flex h-24 w-24 items-center justify-center">
                ...
                />
                <div
                  className="absolute inset-2 rounded-full border-4 border-primary/30 animate-pulse"
                />
              ...
              <h2 className="text-2xl font-bold mb-2">Verifying Aadhaar</h2>
