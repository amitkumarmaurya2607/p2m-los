        ...
        <div className="flex items-center justify-center gap-4 pt-2">
          <button
            ...
            className="px-6 py-3 bg-primary text-white rounded-2xl font-bold flex items-center
              justify-center gap-2 shadow-lg shadow-primary/20 hover:brightness-110 active:scale-95
              transition-all"
          >
            <RefreshCcw size={18} />
            Try Again
          ...
          <Link
            href="/"
            className="px-6 py-3 bg-surface border border-border rounded-2xl font-bold flex
              items-center justify-center gap-2 hover:bg-surface-muted active:scale-95
              transition-all"
          >
            <Home size={18} />
            Home
