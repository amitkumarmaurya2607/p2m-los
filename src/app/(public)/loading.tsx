  ...
  return (
    <div className="min-h-[70vh] w-full flex flex-col items-center justify-center bg-background">
      ...
      <div className="mt-8 text-center space-y-2">
        <h3 className="text-xl font-black text-text-heading tracking-tight">RinSetu<span className="text-secondary">.</span></h3>
        <p className="text-sm font-medium text-text-secondary animate-pulse">Loading secure content...</p>
      </div>
    </div>
  );
}
