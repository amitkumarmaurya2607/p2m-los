...
export default function BankDetailsVerify({ bankDetails }: { bankDetails: BankDetails }) {
            ...
            <div className="w-full max-w-[576px]">
              ...
              bg-green-100"
                        ...
                        <p className="mt-2 text-sm leading-6 text-muted-foreground">
                            Your bank account details have been successfully verified. Please review
                            the information before moving to the next step.
                        </p>
                    </div>
