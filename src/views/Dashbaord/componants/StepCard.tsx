  ...
  lg:shadow-[0px_30px_80px_rgba(15,23,42,0.18)]
   flex"
        >
          ...
          {tips && (
            <div
              className="relative hidden lg:flex w-[352px] rounded-tl-[12px] rounded-bl-[12px]
                overflow-hidden bg-home-green shadow-[4px_0px_32px_rgba(0,0,0,0.08)] text-white px-6
                pt-8 pb-14 flex-col gap-10"
            >
              {/* exact bg layers */}
              <div
                className="absolute inset-0
                  bg-[linear-gradient(135deg,rgba(255,255,255,0.2)_0%,rgba(0,0,0,0)_50%,rgba(55,55,193,0.2)_100%)]"
              />
              ...
              <div
                className="absolute w-[422px] h-[539.38px] left-[-69.88px] top-[-74.36px]
                  ...
                  rounded-bl-[101.749px] [transform:matrix(1,0,-0.26,0.97,0,0)]"
              />
              ...
              <div
                className="absolute w-[299.03px] h-[596px] left-[-52.69px] top-[232.59px]
                  ...
                  rounded-tr-[103.159px] [transform:matrix(0.94,-0.34,0,1,0,0)]"
              />

              <div
                className="absolute inset-0 opacity-[0.06] bg-[url('/image.png')] bg-cover
                  bg-center"
              />
              ...
              <div
                className="relative z-10 overflow-hidden rounded-[10px] p-6
                  bg-[linear-gradient(90deg,#3737C1_0%,#3535BC_12.5%,#3434B7_25%,#3232B2_37.5%,#3131AD_50%,#2F2FA8_62.5%,#2E2EA4_75%,#2C2C9F_87.5%,#2B2B9A_100%)]
              ...
              >
                ...
                <p className="text-[13px] leading-[22px] text-white/75">{tips.description}</p>
              </div>
            </div>
          )}
          ...
          >
            <div className={"w-full"}>
              ...
              {back && (
                <button
                  className="mb-6 flex items-center justify-center w-[40px] h-[40px] bg-muted
                    rounded-full"
                  onClick={back}
                  type="button"
                >
    ...
    <div className="flex gap-12">
      ...
      <div
        className={`w-full max-w-[512px] lg:max-w-none lg:w-[512px] min-h-[430px] p-8 lg:p-12 flex
          flex-col gap-6 lg:gap-8 bg-surface-overlay-90 border border-border-light rounded-[16px]
          lg:rounded-[32px] shadow-[var(--shadow-lg)] ${className}`}
      >
        {back && (
          <button
