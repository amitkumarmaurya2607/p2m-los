...
function AccountStatementUpload() {
  ...
  return (
    ...
    >
      ...
      <div className="  mt-4 flex lg:hidden gap-1">
        <button
          type="button"
          onClick={() => setActiveTab("fetch")}
          className={`rounded-full px-5 py-2.5 grow-1 text-sm font-semibold transition-all ${activeTab === "fetch"
            ? "bg-secondary text-white shadow-md"
            : "border border-border-light text-text-muted hover:bg-muted"
            }`}
        >
        ...
        <button
          type="button"
          onClick={() => setActiveTab("upload")}
          className={`rounded-full px-5 py-2.5 text-sm grow-1 font-semibold transition-all ${activeTab === "upload"
            ? "bg-secondary text-white shadow-md"
            : "border border-border-light text-text-muted hover:bg-muted"
            }`}
        >
      ...
      {activeTab === "upload" ? (
        <div className="mt-6 space-y-6 max-w-[80vw]">

          {
            !file && <>
              ...
              >
                ...
                <p className="mt-1 text-sm text-text-muted-dark">PDF (Max 1MB)</p>
              </div>
            </>
          }
