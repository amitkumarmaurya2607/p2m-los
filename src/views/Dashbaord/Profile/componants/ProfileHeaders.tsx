...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
    ...
    return (
        <header className="sticky top-0 z-30 w-full border-b border-border-medium bg-white/80 backdrop-blur-md shadow-sm">
            <div className="flex h-20 items-center justify-between px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={onMenuClick}
                        className="flex h-10 w-10 items-center justify-center rounded-xl border border-border-medium bg-surface lg:hidden"
                    >
              ...
              outline-none
              transition-all
              placeholder:text-text-dark-blue/50
                ...
                <div className="flex items-center gap-3 sm:gap-5">
                    ...
                    <div className="flex items-center gap-3 border-l border-border-medium pl-3 sm:pl-5">
                        <div className="hidden sm:flex flex-col items-end">
                            ...
                            <span className="text-xs font-medium text-text-muted-dark">
                                {role}
                            </span>
                        </div>

                        <div className="h-10 w-10 overflow-hidden rounded-full border border-border-medium bg-border-medium">
                            {userData?.img ? (
                                <img
                                    src={userData?.img}
                                    alt={userData?.name}
                                ...
                                <div className="flex h-full w-full items-center justify-center text-sm font-semibold text-text-heading">
