...
import { X, FileText, User, Briefcase, Landmark, FolderOpen, Settings, LogOut } from "lucide-react";
...
export default function ProfileSidebar({ open, setOpen }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={` fixed left-0 top-0 z-50 flex h-screen w-72 flex-col border-r
          border-border-medium bg-surface shadow-sm transition-transform duration-300
          ...
          <div className="flex items-center gap-3">
            <div
              className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br
                from-home-green to-home-purple text-lg font-bold text-white shadow"
            >
              F
            </div>

            <h2
              className="bg-gradient-to-r from-text-heading to-text-secondary bg-clip-text text-2xl
