    ...
    >
      ...
      <div className="w-full min-w-0">
        ...
        >
          ...
          {/* Info grid */}
          <div
            className="mt-6 grid grid-cols-2 gap-x-4 gap-y-6 sm:mt-8 sm:gap-x-6 sm:gap-y-8
              lg:grid-cols-3"
          >
        ...
        {/* Notice skeleton */}
        <div
          className="mt-4 flex items-start gap-2.5 rounded-2xl border border-[#F1F5F9] bg-white p-3
            shadow-[0px_8px_32px_-12px_rgba(0,0,0,0.04)] sm:mt-6 sm:gap-3 sm:p-4"
        >
      ...
      <div
        className="w-full rounded-2xl border border-[#F1F5F9] bg-white p-4
          shadow-[0px_8px_32px_-12px_rgba(0,0,0,0.05)] sm:rounded-3xl sm:p-6 lg:max-w-[306px]
          lg:p-8"
      >
        ...
        <div className="mt-6 border-l-2 border-[#F1F5F9] pl-5 sm:mt-8 sm:pl-6">
          {Array.from({ length: 6 }).map((_, index) => (
            <div key={index} className="relative pb-6 last:pb-0 sm:pb-8">
              <SkeletonBlock
                className="absolute -left-[29px] top-0 h-3.5 w-3.5 rounded-full sm:-left-[33px]
                  sm:h-4 sm:w-4"
              />
