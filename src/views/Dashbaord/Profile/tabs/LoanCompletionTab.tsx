  ...
  <div className="space-y-5">
    <ProfileInfoCard title="Loan Completion" icon={CheckCircle2}>
      <div className="rounded-2xl border border-border-light bg-surface-muted p-5 my-6 text-center">
        ...
        <h3 className="text-xl font-bold text-text-heading sm:text-2xl">Loan Completion Pending</h3>

        <p className="mx-auto mt-2 max-w-lg text-sm leading-6 text-text-secondary sm:text-base">
          Once all EMIs are paid successfully, your loan completion certificate and NOC will be
          available here.
        </p>
        ...
        <button
          type="button"
          disabled
          className="mt-5 inline-flex cursor-not-allowed items-center justify-center gap-2
            rounded-xl bg-muted px-5 py-3 text-sm font-semibold text-text-muted"
        >
          Download NOC
    ...
    <div className="grid gap-4 sm:grid-cols-3">
      ...
      <ProfileStatCard label="Outstanding" value="₹48,500" icon={CreditCard} />
