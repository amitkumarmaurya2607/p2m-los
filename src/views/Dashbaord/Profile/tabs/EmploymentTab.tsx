    ...
    >
      ...
      <p
        className={`mt-1.5 break-words text-lg font-extrabold leading-6 sm:mt-2 sm:text-2xl
          sm:leading-8 ${green ? "text-[#00A882]" : "text-[#3737C1]"}`}
      >
        {value}
      </p>
    </div>
...
function OfficeAddressCard({ employment }: { employment: EmploymentDetailsType | null }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="mt-2 whitespace-pre-line break-words text-sm font-medium leading-6
            text-[#45556C] sm:leading-[23px]"
        >
          {officeAddress || "-"}
        </p>
      </div>
...
const EmploymentTab = () => {
  ...
  const [employment, setEmployment] = useState<EmploymentDetailsType | null>(null);
        ...
        <div className="space-y-5 sm:space-y-8">
          ...
          >
            <div className="mt-5 grid grid-cols-1 gap-x-8 gap-y-5 sm:mt-6 sm:grid-cols-2 sm:gap-y-6">
              <InfoField label="Employment Type" value={formatValue(employment.employmenttype)} />
              ...
              <InfoField label="Designation" value={formatValue(employment.designation)} />
          ...
          >
            <div className="mt-5 grid grid-cols-1 gap-x-8 gap-y-5 sm:mt-6 sm:grid-cols-2 sm:gap-y-6">
              ...
              <InfoField label="Mode of Salary" value={formatValue(employment.modeOfSalary)} />
              ...
              <InfoField
                ...
                value={`${payslipCount}`}
                icon={<ReceiptText className="h-3.5 w-3.5 text-[#3737C1] sm:h-4 sm:w-4" />}
              />
            </div>
          </WhiteInfoCard>
        </div>
