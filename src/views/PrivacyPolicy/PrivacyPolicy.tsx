...
const PRIVACY_SECTIONS = [
  {
    ...
    iconId: "info",
    content: "Welcome to RinSetu. We value the trust you place in us and are committed to protecting your privacy and personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your data when you use our website and mobile application. By using our services, you agree to the collection and use of information in accordance with this policy. We follow all applicable laws in India, including the Information Technology Act, 2000 and the Digital Personal Data Protection (DPDP) Act, 2023."
  },
  {
    id: "collection",
    title: "2. Information We Collect",
    iconId: "database",
    content: "To provide our digital lending services, we collect various types of information: Personal Identifiable Information (PII) like name and contact details; KYC Documents like digital copies of PAN and Aadhaar; Financial Information like bank statements and income details; and Credit Information fetched from authorized bureaus."
  },
  {
    id: "device-data",
    title: "3. Device & Usage Data",
    iconId: "smartphone",
    content: "When you use the RinSetu app, we collect certain data to prevent fraud and assess creditworthiness: Device Info (model, OS version); Location access to ensure service availability; App Metadata for risk patterns; and transaction-related SMS Metadata to calculate debt-to-income ratios."
  },
  {
    id: "usage",
    title: "4. How We Use Your Data",
    iconId: "eye",
    content: "We use the collected information to: verify your identity and perform KYC checks; assess your creditworthiness and loan eligibility; facilitate loan processing and disbursal with our RBI-registered NBFC partners; and communicate with you regarding your application and security."
  },
  {
    id: "sharing",
    title: "5. Data Sharing & Disclosure",
    iconId: "share",
    content: "We do not sell your personal data. We only share information with: RBI-registered Lending Partners; Service Providers like cloud hosting and payment gateways; Credit Bureaus; and Legal Authorities when required by law."
  },
  {
    id: "security",
    title: "6. Data Security",
    iconId: "lock",
    content: "We implement bank-grade security measures to protect your data: 256-bit SSL/TLS encryption for transmission; Data storage on secure servers within India compliant with RBI guidelines; and strict internal access controls."
  },
  {
    id: "rights",
    title: "7. Your Rights",
    iconId: "user",
    content: "Under the DPDP Act, you have the following rights: Right to Access your data; Right to Correction of inaccurate information; Right to Withdrawal of consent; and Right to Erasure when data is no longer needed."
  }
];
