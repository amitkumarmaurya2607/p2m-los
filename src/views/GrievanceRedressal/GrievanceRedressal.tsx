    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20 selection:text-primary">
      ...
      <section className="py-24 bg-surface-muted border-y border-border">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-surface rounded-[40px] p-8 md:p-12 border border-border shadow-xl text-center relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-bl-[100px]" />
            <Globe className="w-16 h-16 text-primary mx-auto mb-6" />
            <h2 className="text-3xl md:text-4xl font-black text-text-heading mb-6 tracking-tight">Ombudsman Scheme</h2>
            <p className="text-text-secondary text-lg leading-relaxed mb-8">
              In case your complaint is not redressed within a period of one month from the date of its receipt, or if you are not satisfied with the reply, you may appeal to the <strong>RBI Ombudsman</strong> under the Reserve Bank - Integrated Ombudsman Scheme, 2021.
            </p>
            <a 
              href="https://cms.rbi.org.in" 
              target="_blank" 
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-primary font-black hover:underline group"
            >
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4">
          <div className="relative bg-dark-navy rounded-[40px] p-8 md:p-16 overflow-hidden text-center shadow-2xl">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6 tracking-tight">Need help with a complaint?</h2>
