          ...
          <nav className="space-y-1">
            ...
            >
              ...
              <ChevronRight
                size={14}
                className={`transition-transform
                  ${activeSection === "officer-details" ? "translate-x-1" : "opacity-0 group-hover:opacity-100"}`}
              />
            </button>
          </nav>
        </div>
        ...
        <div id="officer-details" className="space-y-8">
          <div className="bg-surface rounded-3xl border border-border p-6 lg:p-10 shadow-sm">
            <div className="flex items-center gap-4 mb-8">
              <div
                className="w-12 h-12 rounded-2xl bg-secondary/10 text-secondary flex items-center
                  justify-center"
              >
                <Briefcase size={24} />
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {/* Grievance Officer */}
              <div
                className="p-8 bg-surface-muted rounded-[32px] border border-border relative
                  overflow-hidden group"
              >
                <div
                  className="absolute top-0 right-0 w-24 h-24 bg-primary/5 rounded-bl-[100px]
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-lg font-black text-text-heading">
                  ...
                  <div
                    className="flex items-center gap-3 text-sm font-bold text-primary bg-white p-3
              ...
              {/* Nodal Officer */}
              <div
                className="p-8 bg-dark-navy rounded-[32px] text-white relative overflow-hidden group
                  shadow-xl"
              >
                <div
                  className="absolute top-0 right-0 w-24 h-24 bg-white/5 rounded-bl-[100px]
                    group-hover:scale-110 transition-transform"
                />
                <h3 className="text-lg font-black text-secondary mb-6 flex items-center gap-2">
                  <div
                    className="w-2 h-2 rounded-full bg-secondary
                      shadow-[0_0_10px_rgba(13,148,136,0.5)]"
                  />
                ...
                <div className="space-y-4">
                  <div>
                    <p
                      className="text-xs font-bold text-text-on-dark-muted uppercase tracking-widest
                        mb-1"
                    >
                      Officer In-charge
                    </p>
                  ...
                  <div
                    className="flex items-center gap-3 text-sm font-bold text-secondary bg-white/5
