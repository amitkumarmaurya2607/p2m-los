                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[14px] leading-5 text-text-muted-dark">
                          {item.desc}
                        </p>
                      </div>
                    </div>

                    <ArrowUpRight className="h-6 w-6 text-text-on-dark-muted transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-home-purple" />
                  </div>
                );
              })}
            </div>
