...
const FinalCTA = () => {
  return (
    <div className="relative">
      <section className="relative overflow-hidden bg-home-purple px-5 py-16 font-[Inter] md:px-10 lg:px-20 lg:py-24 pb-0 lg:pb-0">
      ...
      <div className="h-30 bg-gradient-to-b from-home-purple to-[#0F172A] relative top-0 z-[1]" />
    </div>
  );
};
