...
const FinalCTA = () => {
  return (
    <section className="relative overflow-hidden bg-home-purple px-5 py-16 font-[Inter] md:px-10 lg:px-20 lg:py-24">
      ...
      <div className="relative mx-auto max-w-[1217px] rounded-[48px] border border-white/20 bg-white/10 px-8 py-12 shadow-[0px_25px_50px_-12px rgba(0,0,0,0.25)] md:px-14 lg:min-h-[492px] lg:px-[81px] lg:py-[81px]">
        ...
        <div className="mt-12 flex justify-center lg:absolute lg:right-[82px] lg:top-[102px] lg:mt-0">
          <div className="relative">
            ...
            <div className="absolute -bottom-1 -left-12 flex h-[74px] w-[151px] items-center gap-3 rounded-2xl border border-border-light bg-white px-4 shadow-[0px_20px_25px_-5px_rgba(0,0,0,0.1),0px_8px_10px_-6px_rgba(0,0,0,0.1)]">
