    ...
    <section className="py-20 bg-surface">
      <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
        ...
        <div className="text-left space-y-4">
          {faqs.map((faq, idx) => (
            <div key={idx} className="bg-surface border border-border rounded-xl overflow-hidden shadow-[var(--shadow-sm)]">
              <button 
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-transform duration-300 ${openIndex === idx ? 'bg-primary text-white rotate-180' : 'bg-muted text-text-muted'}`}>
                  <ChevronDown size={20} />
                </div>
              </button>
