...
const steps = [
  { title: "Download App", desc: "Get it on iOS or Android", icon: Smartphone },
  { title: "Verify KYC", desc: "Paperless digital process", icon: FileText },
  { title: "Check Limit", desc: "Instant eligibility check", icon: CheckCircle2 },
  { title: "Get Funds", desc: "Direct to bank account", icon: IndianRupee },
];
        ...
        <div className="mt-14 grid items-center gap-10 lg:mt-20 lg:grid-cols-[1fr_420px_1fr]">
          ...
          <div className="relative space-y-10">
            ...
            {steps.map((step, index) => (
              <div key={step.title} className="relative z-10 flex gap-8">
