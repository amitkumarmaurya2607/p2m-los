  ...
  return (
    <section className="relative pt-[32px]   px-6 lg:px-12 bg-surface-muted overflow-hidden">
      ...
      <div className="max-w-[var(--max-width-section)] mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="relative hidden lg:flex  w-50% max-w-[700px]  lg:h-full flex items-end justify-center bg-[url('/images/moeny.png')] bg-no-repeat bg-top bg-[length:100%] bg-[center_top_0px] bg-no-repeat">
