...
export default function FinancialWisdom() {
  const blogs = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1579621970588-a35d0e7ab9b6?auto=format&fit=crop&q=80&w=400&h=250",
      date: "Oct 08, 2026"
    },
    {
      title: "Smart ways to use your Diwali bonus",
      category: "Personal Finance",
      image: "https://images.unsplash.com/photo-1601597111158-2fceff292cdc?auto=format&fit=crop&q=80&w=400&h=250",
      date: "Oct 01, 2026"
    }
  ];
    ...
    <section className="py-20 bg-surface">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {blogs.map((blog, idx) => (
            <div key={idx} className="bg-surface border border-border rounded-2xl overflow-hidden shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-md)] transition-shadow group cursor-pointer">
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-3">
                  <span className="text-xs font-bold text-secondary uppercase tracking-wider">{blog.category}</span>
