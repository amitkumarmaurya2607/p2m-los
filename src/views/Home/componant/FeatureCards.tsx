    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-12 -mt-16 relative z-10">
      <div className="grid md:grid-cols-3 gap-6">
        {features.map((feature, idx) => (
          <div key={idx} className="bg-surface rounded-2xl p-6 shadow-[var(--shadow-md)] border border-border flex items-start gap-4 transition-transform hover:-translate-y-1">
            <div className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 ${feature.bgColor}`}>
              {feature.icon}
            </div>
            <div>
