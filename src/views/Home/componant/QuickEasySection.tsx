    ...
    <section className="w-full overflow-hidden bg-white px-4 py-14 sm:px-6 lg:px-0 lg:py-24">
      <div className="mx-auto flex max-w-[1257px] flex-col items-center gap-12 lg:flex-row lg:justify-between">
        ...
        <div className="w-full max-w-[576px]">
          <h2 className="text-[38px] font-extrabold leading-[48px] text-dark-navy sm:text-[48px] sm:leading-[60px]">
            Quick, Easy & <br />
          ...
          <div className="mt-9 flex flex-col gap-6">
            {points.map((item, index) => (
              ...
              >
                <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-home-green shadow-[0px_5.33391px_8.00087px_-1.33348px_rgba(0,0,0,0.1),0px_2.66696px_5.33391px_-2.66696px_rgba(0,0,0,0.1)]">
